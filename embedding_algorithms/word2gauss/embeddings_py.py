...
from embedding_algorithms.word2gauss import iter_pairs
...
class GaussianEmbedding(BasicEmbedding):
    def __init__(self, dataset, vocab, vec_dim, epoch,
                 covariance_type='spherical',energy='KL',
                 C=1.0, m=0.1, M=10.0, Closs=1.0, eta=1.0):
        ...
        '''
        super(GaussianEmbedding, self).__init__(dataset, vocab, vec_dim, epoch,)
        N = len(vocab)
        ...
        self.pairs = iter_pairs(dataset, vocab)
